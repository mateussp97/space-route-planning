...
export default function Page() {
  return (
    <div className="w-full h-screen bg-background flex flex-col">
      ...
      <div className="w-full h-fit bg-transparent py-8 md:py-16 px-4 flex flex-col">
        <div className="max-w-7xl w-full h-fit mx-auto grid grid-cols-1 md:grid-cols-2 items-stretch gap-8">
