            ...
            <div key={index} className="w-full flex flex-col items-start">
              <ul className="grid gap-3">
                <li className="flex items-center justify-between">
                  ...
                  <span>{travel.createdAt.toString()}</span>
                </li>
                <li className="flex items-center justify-between">
                  <span className="text-muted-foreground">
                    fuel before the trip
                  </span>
                  <span>{travel.availableFuel}</span>
                </li>
                <li className="flex items-center justify-between">
                  <span className="text-muted-foreground">from</span>
                  <span>{travel.currentPlanet}</span>
                </li>
                <li className="flex items-center justify-between">
                  <span className="text-muted-foreground">to</span>
                  <span>{travel.destinationPlanet}</span>
                </li>
                <li className="flex items-center justify-between">
                  <span className="text-muted-foreground">spent fuel</span>
                  <span>{travel.requiredFuel}</span>
                </li>
              </ul>
              <Separator className="my-2" />
            </div>
